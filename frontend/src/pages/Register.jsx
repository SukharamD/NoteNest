...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://notenest-dwfg.onrender.com/api/register/', {
        method: 'POST',
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 p-4">
      <div className="bg-white shadow-2xl rounded-xl px-8 py-10 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="cursor-pointer w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 rounded-lg transition duration-300"
          >
            Register
          </button>
